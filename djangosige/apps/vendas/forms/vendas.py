...
class VendaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'mod_frete': ('Modalidade do frete'),
            'local_orig': ('Localização de estoque de origem dos produtos'),
            'movimentar_estoque': ('Movimentar estoque?'),
            'veiculo': ('Veículo'),
            'vendedor': ('Vendedor'),
            'valor_total': ('Total (R$)'),
            'tipo_desconto': ('Tipo de desconto'),
            'desconto': ('Desconto (% ou R$)'),
            'frete': ('Frete (R$)'),
            'despesas': ('Despesas (R$)'),
            'seguro': ('Seguro (R$)'),
            'impostos': ('Impostos (R$)'),
...
class OrcamentoVendaForm(VendaForm):
    ...
    class Meta(VendaForm.Meta):
        ...
        labels['data_vencimento'] = ('Data de Vencimento')
...
class ItensVendaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'tipo_desconto': ('Tipo de desconto'),
            'desconto': ('Desconto (% ou R$)'),
            'valor_rateio_frete': ('Frete(R$)'),
            'valor_rateio_despesas': ('Despesas(R$)'),
            'valor_rateio_seguro': ('Seguro(R$)'),
