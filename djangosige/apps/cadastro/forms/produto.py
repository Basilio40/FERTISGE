...
class ProdutoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            'codigo': ('Código'),
            'codigo_barras': ('Código de Barras (GTIN/EAN)'),
            'descricao': ('Descrição'),
            'categoria': ('Categoria'),
            'marca': ('Marca'),
            'unidade': ('Unidade'),
            ...
            'grupo_fiscal': ('Grupo Fiscal (Padrão)'),
            'estoque_minimo': ('Qtd. em estoque mínima'),
            'controlar_estoque': ('Controlar estoque deste produto?'),
        }
