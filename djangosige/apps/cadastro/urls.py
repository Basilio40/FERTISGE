...
urlpatterns = [
    ...
    # cadastro/cliente/excluir/
    path('cliente/excluir/<int:pk>/',
         ExcluirClienteView.as_view(), name='excluirclienteview'),
    ...
    # cadastro/transportadora/excluir/
    path('transportadora/excluir/<int:pk>/',
         ExcluirTransportadoraView.as_view(), name='excluirtransportadoraview'),
    ...
    # cadastro/produto/excluir/
    path('produto/excluir/<int:pk>/',
         ExcluirProdutoView.as_view(), name='excluirprodutoview'),
    ...
    # cadastro/outros/excluirunidade/
    path('outros/excluirunidade/<int:pk>/',
         ExcluirUnidadeView.as_view(), name='excluirunidadeview'),
