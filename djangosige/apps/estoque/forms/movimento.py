...
class MovimentoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            'quantidade_itens': ('Nº de itens'),
            'valor_total': ('Valor total dos produtos (R$)'),
...
class EntradaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        labels['data_movimento'] = ('Data da entrada')
        labels['tipo_movimento'] = ('Tipo')
        labels['pedido_compra'] = ('Pedido de compra')
        labels['fornecedor'] = ('Fornecedor')
        labels['local_dest'] = ('Local de destino')
...
class SaidaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        labels = MovimentoForm.Meta.labels
        labels['data_movimento'] = ('Data da saída')
        labels['tipo_movimento'] = ('Tipo')
        labels['pedido_venda'] = ('Pedido de venda')
        labels['local_orig'] = ('Local de origem')
...
class TransferenciaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        widgets['local_estoque_dest'] = forms.Select(
            attrs={'class': 'form-control'})
        labels = MovimentoForm.Meta.labels
        labels['data_movimento'] = ('Data da transferência')
        labels['local_estoque_orig'] = ('Local de origem')
        labels['local_estoque_dest'] = ('Local de destino')
