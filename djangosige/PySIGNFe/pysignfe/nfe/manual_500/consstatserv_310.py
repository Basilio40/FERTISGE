...
from djangosige.PySIGNFe.pysignfe.nfe.manual_401 import consstatserv_200
from djangosige.PySIGNFe.pysignfe.xml_sped import *
from djangosige.PySIGNFe.pysignfe.nfe.manual_500 import ESQUEMA_ATUAL
...
class RetConsStatServ(consstatserv_200.RetConsStatServ):
    def __init__(self):
        ...
        self.dhRecbto  = TagDataHoraUTC(nome=u'dhRecbto' , codigo=u'FR10', raiz=u'//retConsStatServ')
        self.caminho_esquema = os.path.join(DIRNAME, u'schema', ESQUEMA_ATUAL + u'/')
