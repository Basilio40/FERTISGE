...
from djangosige.PySIGNFe.pysignfe.nfe.webservices_flags import CODIGO_UF, UF_CODIGO
from .webservices_flags import *
from . import webservices

from djangosige.PySIGNFe.pysignfe.xml_sped.certificado import Certificado
