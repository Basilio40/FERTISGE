...
from djangosige.PySIGNFe.pysignfe.nfs_e import nfs_e
from djangosige.PySIGNFe.pysignfe.nfse.bhiss.v10.Rps import Rps as Rps_10
...
if __name__ == '__main__':
    ...
    resultado = mynfse.gerar_nfse(lista_rps=lista_rps, cert=info_certificado['cert'], key=info_certificado['key'], ambiente=2, versao=u'1.0', modelo=u'bhiss')
