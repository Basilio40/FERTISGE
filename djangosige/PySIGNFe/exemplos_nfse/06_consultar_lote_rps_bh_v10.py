...
if __name__ == '__main__':
    ...
    resultado = mynfse.consultar_lote_rps(cnpj=cnpj, im=im, protocolo=protocolo, cert=info_certificado['cert'], key=info_certificado['key'], ambiente=2, versao=u'1.0', modelo=u'bhiss')
